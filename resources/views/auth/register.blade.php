...
<body class="bg-gray-100">
    <div class="container mx-auto p-4 max-w-md">
        <h1 class="text-2xl font-bold mb-4 text-center">Registra't</h1>
        <form method="POST" action="{{ route('register') }}">
            ...
            @if (Route::has('login'))
                <a href="{{ route('login') }}" class="block text-center text-blue-500 mt-2">Ja tens compte? Inicia sessió</a>
            @endif
        </form>
    </div>
</body>
